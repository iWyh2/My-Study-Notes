...
对于字符串的相关操作，如频繁的拼接，修改等，建议用StringBuilder

如果操作字符串较少，或者不需要操作，只是定义字符串变量，用String

### StringBuffer类

StringBuffer类与StringBuilder类用法一模一样，代码都无需更改即可使用。

唯一区别在于，StringBuilder是线程不安全的，StringBuffer是线程安全的
